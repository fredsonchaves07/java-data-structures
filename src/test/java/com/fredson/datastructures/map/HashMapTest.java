...
public class HashMapTest {
    ...
    public void shouldAddElementInMap() {
        ...
        String expected = "[{'Terceira categoria':100}, {'Segunda categoria':65}, {'Primeira categoria':10}]";
    ...
    public void shouldRemoveElementInMap() {
        Map<String, Integer> map = new HashMap<>();
        String expected = "[{'Terceira categoria':100}, {'Primeira categoria':10}]";
        map.set("Primeira categoria", 10);
        map.set("Segunda categoria", 65);
        map.set("Terceira categoria", 100);
    ...
    public void shouldGetKeysInMap() {
        Map<String, Integer> map = new HashMap<>();
        String expected = "[Terceira categoria, Segunda categoria, Primeira categoria]";
        map.set("Primeira categoria", 10);
        map.set("Segunda categoria", 65);
        map.set("Terceira categoria", 100);
