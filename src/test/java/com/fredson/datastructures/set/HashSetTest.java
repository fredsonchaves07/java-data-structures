...
public class HashSetTest {
    ...
    public void shouldAddElement() {
        ...
        String stringExpected = "[Javascript, Python, Java, C]";
        set.add("Java");
        set.add("Python");
        set.add("Javascript");
        set.add("C");
    ...
    public void shouldDeleteElement() {
        Set<String> set = new HashSet<>();
        String stringExpected = "[Python, Java, C]";
        set.add("Java");
        set.add("Python");
        set.add("Javascript");
        set.add("C");
    ...
    public void shouldGetElements() {
        Set<String> set = new HashSet<>();
        String expected = "[Javascript, Python, Java, C]";
        set.add("Java");
        set.add("Python");
        set.add("Javascript");
        set.add("C");
